#ifndef QUINCE__mappers__detail__array_of_int64_h
#define QUINCE__mappers__detail__array_of_int64_h
...
// Low-level representation of int64_t[], as used in a cell.
//
...
namespace quince {
    BOOST_STRONG_TYPEDEF(std::string, array_of_int64)
}
