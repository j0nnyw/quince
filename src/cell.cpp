...
void cell::set(const time_type &src) {
    set_type(get_column_type<time_type>());
    set_string(src);
}

void cell::set(const date_type &src) {
    set_type(get_column_type<date_type>());
    set_string(src);
}
...
void cell::set(const numeric_type &src) {
    set_type(get_column_type<numeric_type>());
    set_string(src);
}
...
void cell::get(time_type &dest) const {
    check_type<string>();
    get_string(dest);
}
...
void cell::get(numeric_type &dest) const {
    check_type<string>();
    get_string(dest);
}
